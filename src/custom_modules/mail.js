...
const reusableHTML = {sciChanges, replacedOrgsInfo, greeting, taxDeductionInfo, footer};
...
async function send(options) {
    const templateRoot = `./${process.env.NODEMON ? 'src' : 'dist'}/views/mail/${options.templateName}`
