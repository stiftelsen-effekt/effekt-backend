...
router.post(
  ...
  async (req, res, next) => {
    try {
      const reportsWithUserOnProfilePage =
        await DAO.tax.getReportsWithUserOnProfilePage();
      const reportsWithoutUserOnProfilePage =
        await DAO.tax.getReportsWithoutUserOnProfilePage();
      ...
      let results = [];
      const totalEmails =
        reportsWithUserOnProfilePage.length +
        reportsWithoutUserOnProfilePage.length;
