...
module.exports = {
    ...
    createDateObjectsFromExpressRequest: function(req) {
        ...
        if (!req.query) throw "No query parameters, please include fromDate and toDate parameters in ISO_8601 format."

        //Check if dates are valid ISO 8601
        if (!moment(req.query.fromDate, moment.ISO_8601, true).isValid() || !moment(req.query.toDate, moment.ISO_8601, true).isValid()) throw "Dates must be in ISO 8601 format";
